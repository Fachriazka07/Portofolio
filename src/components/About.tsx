...
export function About() {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="py-32 bg-white dark:bg-[#0f0f1a] relative overflow-hidden transition-colors duration-300"
    >
          ...
          <div ref={imageRef} className="relative group order-1 md:order-2">
            ...
            <div className="relative">
              <img
                src={meImage}
                alt="Fachri Azka"
                className="relative rounded-3xl shadow-2xl w-full h-[500px] object-cover ring-4 ring-white dark:ring-[#1a1a2e]"
              />
