...
export function Hero() {
  ...
  // removed landing menu nav (now handled via tabbed PortfolioShowcase)
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Animasi title dengan efek split - jeda 0.3 detik
      tl.fromTo(
        titleRef.current,
      ...
      // Animasi subtitle - jeda 0.3 detik
      tl.fromTo(
        subtitleRef.current,
      ...
      // Animasi description dengan efek word reveal - langsung setelah subtitle
      ...
      // Set initial state untuk buttons
      if (buttonsRef.current) {
        ...
        // Animasi buttons dengan efek 3D - jeda 0.3 detik
        tl.to(
      ...
      // landing menu removed

      // Tambahkan floating animation untuk badge di akhir
      tl.to(
        badgeRef.current,
        {
          y: -8,
  ...
  return (
    ...
    >
      ...
      {/* Enhanced Playful geometric shapes */}
      ...
      {/* New decorative elements with different shapes and positions */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-20 text-center">
        <div className="space-y-6">
          ...
          <h1
            ref={titleRef}
            className="text-6xl md:text-7xl lg:text-8xl text-gray-900 dark:text-white opacity-0"
          >
            I'm{" "}
          ...
          <h2
            ref={subtitleRef}
            className="text-xl md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 opacity-0"
          >
          ...
          <p
            ref={descriptionRef}
            className="text-base md:text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto opacity-0"
          >
